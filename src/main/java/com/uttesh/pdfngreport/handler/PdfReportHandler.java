...
import com.uttesh.util.chart.ChartStyle;
...
/**
 * This is a handler class for the pdf report generation, it generate the jfreechart image and xsl fo pdf report
...
public class PdfReportHandler {
    ...
    /**
     * This method generate the XML data file required by the apache fo to generate the PDF report.
     * XML data file is generated by using the java JAXB. 
     * 
     * @param reportData 
    ...
    /**
     * This method generate the PDF report by report data and the report store location.
     * After the report generation it will remove the temp file created by the generator i.e XML data file and chart image file.
     * @param reportData
     * @param reportFile
